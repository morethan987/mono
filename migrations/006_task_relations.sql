...
ALTER TABLE tasks ADD COLUMN IF NOT EXISTS spawned_from_task_id TEXT REFERENCES tasks(id);
...
CREATE INDEX IF NOT EXISTS idx_tasks_spawned ON tasks(spawned_from_task_id);
CREATE INDEX IF NOT EXISTS idx_relations_source ON task_relations(source_task_id);
CREATE INDEX IF NOT EXISTS idx_relations_related ON task_relations(related_task_id);
